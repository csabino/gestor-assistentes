...
>
    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-20'" class="bg-indigo-700 text-white min-h-screen transition-all duration-300 flex flex-col justify-between shrink-0 shadow-lg relative z-50">
        <div>
            ...
            <div class="h-16 flex items-center px-4 justify-between border-b border-indigo-600/80">
                <a href="/" class="font-bold text-lg flex items-center gap-3 truncate hover:text-indigo-200 transition">
                    ...
                    <span x-show="sidebarOpen" class="truncate font-bold tracking-wide">Painel IA</span>
                </a>
                <button type="button" @click="sidebarOpen = !sidebarOpen; localStorage.setItem('sidebar_open', sidebarOpen)" class="p-1.5 rounded-lg hover:bg-indigo-600 text-indigo-200 hover:text-white transition cursor-pointer" title="Alternar menu">
                    <svg x-show="sidebarOpen" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" /></svg>
                    <svg x-show="!sidebarOpen" x-cloak class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg>
                </button>
            </div>

            <!-- NAVEGAÇÃO PRINCIPAL COM ÍCONES FLAT -->
            <nav class="p-3 space-y-1.5 font-medium text-sm">
                <a href="/" class="flex items-center gap-3.5 px-3 py-2.5 rounded-xl transition font-semibold {{ $currentView === 'robots' ? 'bg-indigo-900/90 text-white shadow-sm border border-indigo-500/30' : 'text-indigo-100 hover:bg-indigo-600' }}">
                ...
                <a href="/?view=equipe" class="flex items-center gap-3.5 px-3 py-2.5 rounded-xl transition font-semibold {{ $currentView === 'equipe' ? 'bg-indigo-900/90 text-white shadow-sm border border-indigo-500/30' : 'text-indigo-100 hover:bg-indigo-600' }}">
                ...
                <a href="/?view=agenda" class="flex items-center gap-3.5 px-3 py-2.5 rounded-xl transition font-semibold {{ $currentView === 'agenda' ? 'bg-indigo-900/90 text-white shadow-sm border border-indigo-500/30' : 'text-indigo-100 hover:bg-indigo-600' }}">
                ...
                <a href="/?view=settings" class="flex items-center gap-3.5 px-3 py-2.5 rounded-xl transition font-semibold {{ $currentView === 'settings' ? 'bg-indigo-900/90 text-white shadow-sm border border-indigo-500/30' : 'text-indigo-100 hover:bg-indigo-600' }}">
        ...
        <div class="p-4 border-t border-indigo-600/80">
            <span x-show="sidebarOpen" class="text-[11px] bg-indigo-800 text-indigo-200 px-3 py-1 rounded-full font-medium border border-indigo-500 block text-center shadow-inner">Multi-Model v2.0</span>
