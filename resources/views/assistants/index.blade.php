    ...
    <div class="container mx-auto mt-6 px-4 max-w-5xl mb-12">
        ...
        @if($configuring)
            <div class="mb-5 flex items-center justify-between">
                <a href="/" class="text-indigo-600 hover:text-indigo-800 font-semibold flex items-center gap-1.5 text-sm transition">
                ...
                <form action="/" method="POST">
                    ...
                    <button type="submit" class="text-sm px-4 py-1.5 rounded-full font-semibold transition border flex items-center gap-2 {{ $configuring->is_active ? 'bg-emerald-50 text-emerald-700 border-emerald-200 hover:bg-emerald-100' : 'bg-gray-100 text-gray-600 border-gray-300 hover:bg-gray-200' }}">
                        @if($configuring->is_active)
                            <svg class="w-2 h-2 fill-emerald-500" viewBox="0 0 8 8"><circle cx="4" cy="4" r="3" /></svg> IA Ativa
                        @else
                            <svg class="w-2 h-2 fill-gray-400" viewBox="0 0 8 8"><circle cx="4" cy="4" r="3" /></svg> IA Inativa
                        @endif
                    </button>
                </form>
            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                            ...
                            <textarea name="system_prompt" rows="8" class="w-full border border-gray-300 rounded-lg p-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" placeholder="Ex: Você é um vendedor especializado na loja X. Seja cordial e sempre consulte a base de conhecimento...">{{ $configuring->system_prompt }}</textarea>
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Botão Salvar -->
                        <button type="submit" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3.5 rounded-xl shadow-md transition text-base flex justify-center items-center gap-2">
                ...
                @forelse($assistants as $assistant)
                    <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-200 hover:border-indigo-300 hover:shadow-md transition duration-200 flex flex-col justify-between gap-4">
                        ...
                        <div class="flex items-center justify-between border-t border-gray-100 pt-4 gap-2">
                            <a href="/?configure={{ $assistant->id }}" class="bg-white border border-gray-200 hover:border-indigo-300 hover:text-indigo-700 text-gray-600 font-medium py-1.5 px-3 rounded-lg text-xs transition flex-1 flex items-center justify-center gap-2">
                        ...
                        @forelse($assistants as $assistant)
                            <tr class="hover:bg-gray-50 transition duration-150 group">
                                ...
                                <td class="py-3 px-4 text-right flex justify-end items-center gap-2 opacity-80 group-hover:opacity-100 transition">
                                    <a href="/?configure={{ $assistant->id }}" class="bg-white border border-gray-200 hover:border-indigo-300 hover:text-indigo-700 text-gray-600 font-medium py-1.5 px-3 rounded-lg text-xs transition flex items-center justify-center gap-1.5">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3.5 h-3.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 12c0-1.232-.046-2.453-.138-3.662a4.006 4.006 0 00-3.7-3.7 48.678 48.678 0 00-7.324 0 4.006 4.006 0 00-3.7 3.7c-.017.22-.032.441-.046.662M19.5 12l3-3m-3 3l-3-3m-12 3c0 1.232.046 2.453.138 3.662a4.006 4.006 0 003.7 3.7 48.656 48.656 0 007.324 0 4.006 4.006 0 003.7-3.7c.017-.22.032-.441.046-.662M4.5 12l3 3m-3-3l-3 3" /></svg> Configurar
                                    </a>
