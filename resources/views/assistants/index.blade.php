                            ...
                            @if($configuring->knowledge_files && count($configuring->knowledge_files) > 0)
                                <div class="mb-5 bg-gray-50 p-4 rounded-lg border border-gray-200">
                                    <h4 class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">
                                        Documentos Anexados ({{ count($configuring->knowledge_files) }})
                                    </h4>
                                        ...
                                        @foreach($configuring->knowledge_files as $index => $file)
                                            <li class="flex items-center justify-between bg-white px-3 py-2 border border-gray-200 rounded-md shadow-sm">
                                                <div class="flex items-center gap-2 truncate">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-gray-400 shrink-0"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" /></svg>
